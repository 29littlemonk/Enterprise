...
//		statePanel.add(companyLabel);
//		spring.putConstraint(SpringLayout.EAST, companyLabel, -5, SpringLayout.EAST, this.getContentPane());
//		spring.putConstraint(SpringLayout.SOUTH, companyLabel, -5, SpringLayout.SOUTH, this.getContentPane());
//		statePanel.add(dateLabel);
//		statePanel.add(getUserLabel());
//		statePanel.add(getStateLabel());
//		
//		spring.putConstraint(SpringLayout.EAST, dateLabel, -5, SpringLayout.EAST, companyLabel);
//		spring.putConstraint(SpringLayout.EAST, getUserLabel(), -5, SpringLayout.EAST, dateLabel);
//		spring.putConstraint(SpringLayout.EAST, getStateLabel(), -5, SpringLayout.EAST, getUserLabel());
		return statePanel;
	}
